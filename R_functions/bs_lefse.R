...
#' 
#' LeFSe Parameters kw_cutoff, lda_cutoff, wilcoxon_cutoff are "switched offset"
...
bs_lefse <- function(counts,meta,groupVariable="condition",fileName=NULL,doRarefy=T){
  ...
  if(is.null(res))
    ...
    print(paste0("lefse succeeded with relaxed threshold Delta=",Delta-0.05))
