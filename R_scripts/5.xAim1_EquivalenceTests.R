...
dfFolder <- "../Results/3.1_metaSPARSim_DataProps"
outFolder <- "../Results/5.1_Aim1_metaSPARSim"
...
dfFolder <- "../Results/3.2_metaSPARSim_ZerosAdded_DataProps"
outFolder <- "../Results/5.1_Aim1_metaSPARSim_ZerosAdded"
if(dir.exists(outFolder) && dir.exists(dfFolder)){
  source("script_5.x_Aim1_EquivalenceTests.R")
}else{
  warning(outFolder, " or ", dfFolder, "does not exist !!!!!!!!!!!!")
...
dfFolder <- "../Results/3.3_metaSPARSim_Filtered_DataProps"
outFolder <- "../Results/5.1_Aim1_metaSPARSim_filtered"
if(dir.exists(outFolder) && dir.exists(dfFolder)){
  source("script_5.x_Aim1_EquivalenceTests.R")
}else{
  warning(outFolder, " or ", dfFolder, "does not exist !!!!!!!!!!!!")
...
dfFolder <- "../Results/3.4_metaSPARSim_filtered_ZerosAdded_DataProps"
outFolder <- "../Results/5.1_Aim1_metaSPARSim_filtered_ZerosAdded"
if(dir.exists(outFolder) && dir.exists(dfFolder)){
  source("script_5.x_Aim1_EquivalenceTests.R")
}else{
  warning(outFolder, " or ", dfFolder, "does not exist !!!!!!!!!!!!")
...
dfFolder <- "../Results/3.1_sparseDOSSA_DataProps"
outFolder <- "../Results/5.1_Aim1_sparseDOSSA"
if(dir.exists(outFolder) && dir.exists(dfFolder)){
  source("script_5.x_Aim1_EquivalenceTests.R")
}else{
  warning(outFolder, " or ", dfFolder, "does not exist !!!!!!!!!!!!")
...
dfFolder <- "../Results/3.2_sparseDOSSA_ZerosAdded_DataProps"
outFolder <- "../Results/5.1_Aim1_sparseDOSSA_ZerosAdded"
if(dir.exists(outFolder) && dir.exists(dfFolder)){
  source("script_5.x_Aim1_EquivalenceTests.R")
}else{
  warning(outFolder, " or ", dfFolder, "does not exist !!!!!!!!!!!!")
...
dfFolder <- "../Results/3.3_sparseDOSSA_Filtered_DataProps"
outFolder <- "../Results/5.1_Aim1_sparseDOSSA_filtered"
if(dir.exists(outFolder) && dir.exists(dfFolder)){
  source("script_5.x_Aim1_EquivalenceTests.R")
}else{
  warning(outFolder, " or ", dfFolder, "does not exist !!!!!!!!!!!!")
...
dfFolder <- "../Results/3.4_sparseDOSSA_filtered_ZerosAdded_DataProps"
outFolder <- "../Results/5.1_Aim1_sparseDOSSA_filtered_ZerosAdded"
if(dir.exists(outFolder) && dir.exists(dfFolder)){
  source("script_5.x_Aim1_EquivalenceTests.R")
}else{
  warning(outFolder, " or ", dfFolder, "does not exist !!!!!!!!!!!!")
...
saveRDS(numbers,"../Results/NumberOfNonEquivalentDataProps_all.RDS") 
saveRDS(numbers,"../Results_partReg/NumberOfNonEquivalentDataProps_all.RDS")
print(numbers)

openxlsx::write.xlsx(numbers, "../Results/NumberOfNonEquivalentDataProps_all.xlsx", rowNames = T)
openxlsx::write.xlsx(numbers, "../Results_partReg/NumberOfNonEquivalentDataProps_all.xlsx", rowNames = T)
