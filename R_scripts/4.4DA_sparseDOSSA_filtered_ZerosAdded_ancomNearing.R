...
resultFolder <- "../Results/4.4_sparseDOSSA_filtered_ZerosAdded_DA" 
prefix <- "4.4_spd_nearing_"

#source("script_4.x_DA.R")

#resultFolder <- "../Results/4.4_sparseDOSSA_filtered_ZerosAdded_DA_ancom_Nearing" 
