...
dataFolder <- "../Results/3.1_sparseDOSSA_DataProps"
...
###############################
dataFolder <- "../Results/3.2_sparseDOSSA_ZerosAdded_DataProps"
...
###############################
dataFolder <- "../Results/3.3_sparseDOSSA_Filtered_DataProps"
resultFolder <- "../Results/3.3_sparseDOSSA_Filtered_DataProps"
prefix <- "3.3.1"
...
###############################
dataFolder <- "../Results/3.4_sparseDOSSA_filtered_ZerosAdded_DataProps"
resultFolder <- "../Results/3.4_sparseDOSSA_filtered_ZerosAdded_DataProps"
prefix <- "3.4.1"
