...
dataFolder <- "../Results_partReg/3.4_metaSPARSim_filtered_ZerosAdded_DataProps"
resultFolder <- "../Results_partReg/4.4_metaSPARSim_filtered_ZerosAdded_DA" 
prefix <- "4.4pr_"

#source("script_4.x_DA.R")

prefix <- "4.4pr_nearing" # I forgot this, so prefix is the one above => Clemens, do renaming later (3.1.25) 
 resultFolder <- "../Results_partReg/4.4_metaSPARSim_filtered_ZerosAdded_DA_ancom_Nearing"  # I forgot this, so the resultFolder is the on above => Clemens, do moving it later (3.1.25)
