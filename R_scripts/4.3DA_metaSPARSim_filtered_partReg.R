...
dataFolder <- "../Results_partReg/3.3_metaSPARSim_Filtered_DataProps"
resultFolder <- "../Results_partReg/4.3_metaSPARSim_filtered_DA" 
prefix <- "4.3_partReg"

source("script_4.x_DA.R")

#resultFolder <- "../Results_partReg/4.3_metaSPARSim_filtered_DA_ancom_Nearing" 
